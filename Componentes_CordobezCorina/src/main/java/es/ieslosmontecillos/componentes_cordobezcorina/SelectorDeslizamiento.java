...
public class SelectorDeslizamiento extends VBox {
    @FXML
    ...
    public SelectorDeslizamiento() {
        FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("selector-deslizamiento.fxml"));
    ...
    public final ObjectProperty<EventHandler<ActionEvent>> onActionProperty() {
        return null;//onAction;
    }
    public final EventHandler<ActionEvent> setOnAction(EventHandler<ActionEvent> value) {
